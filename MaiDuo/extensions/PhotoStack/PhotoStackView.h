...
@protocol PhotoStackViewDataSource <NSObject>
    ...
    - (NSString *)photoStackView:(PhotoStackView *)photoStack urlForIndex:(NSUInteger)index;
...
@interface PhotoStackView : UIControl <UIGestureRecognizerDelegate>
    ...
    @property (unsafe_unretained, nonatomic) id <PhotoStackViewDataSource> dataSource;
    @property (unsafe_unretained, nonatomic) id <PhotoStackViewDelegate> delegate;
    ...
    @property (nonatomic,assign) PhotoStackViewDataSourceType dataSourceType;
